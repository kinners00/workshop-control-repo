...
curl "https://raw.githubusercontent.com/kinners00/workshop-control-repo/production/workshop_key.enc" -L -o ~/workshop_key.enc
...
git remote add origin git@github.com:kinners00/workshop-control-repo
